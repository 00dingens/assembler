...
;nachdem dann Enter gedrückt wurde,
;werden in C:\WINDOWS\DESKTOP\ und C:\WINDOWS\STARTM~1\PROGRA~1\AUTOST~1\ 
;jeweils nett0000.bat bis nettFFFF.bat erstellt (jeweils 65536 Dateien)
